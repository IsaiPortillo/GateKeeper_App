...
import 'package:gatekeeper/screens/settings_screen.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ElevatedButton(
                ...
                child: const Text('Gestión de Accesos'),
              ),
              ...
              ElevatedButton(
                ...
                child: const Text('Monitorización'),
              ),
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
                ...
                child: const Text('Alertas de Seguridad'),
              ),
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
